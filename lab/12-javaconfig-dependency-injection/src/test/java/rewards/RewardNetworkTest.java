...
class RewardNetworkTest {
    private RewardNetwork _rewardNetwork;

    @BeforeEach
    void setUp() {
        ConfigurableApplicationContext context = SpringApplication.run(TestInfrastructureConfig.class);
        this._rewardNetwork = context.getBean("rewardNetwork", RewardNetwork.class);
    }
    ...
    void testRewardForDining() {
        ...
        RewardConfirmation confirmation = _rewardNetwork.rewardAccountFor(dining);
