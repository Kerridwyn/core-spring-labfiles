...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		Account selectedAccount = accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant selectedRestaurant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount amount = selectedRestaurant.calculateBenefitFor(selectedAccount, dining);
		AccountContribution contribution = selectedAccount.makeContribution(amount);
		accountRepository.updateBeneficiaries(selectedAccount);
